...
<div class='grid_18'>
	<div class='productsheadercontainer'>
		<h3>
			<img style='max-height: 55px;' src='img/productsfnilogo.png' />
		</h3>
	</div>
	<div class='tabs'>
				<ul class='indextabnavigation'>
					<li><b>Fire n' Ice Suite:</b></li>
		...
		<img style='max-width: 620px;' src='img/fniindexpic.png' />
		</div>
